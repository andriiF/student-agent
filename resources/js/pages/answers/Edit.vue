    ...
    <div class="mt-5 grid grid-cols-6 gap-4">
        <div class="col-span-6 px-4 md:col-span-4 md:col-start-2 md:px-0">
            <div class="flex flex-col space-y-6">
                ...
                <Form v-bind="update(props.answer.uuid)" class="space-y-6" v-slot="{ errors, processing }">
                    ...
                    <div class="grid gap-2">
                        ...
                        <Select name="question_id" :default-value="props.answer.question_id" required>
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input
                            ...
                            name="explanation"
                            class="mt-1 block w-full"
                            :default-value="props.answer.explanation ?? ''"
                    ...
                    <div class="flex items-center gap-6">
                        <div class="flex items-center gap-2">
                            <Checkbox id="is_correct" name="is_correct" value="1" :default-checked="props.answer.is_correct" />
                            <Label for="is_correct">Correct answer</Label>
                        </div>
                        <div class="flex items-center gap-2">
                            <Checkbox id="is_active" name="is_active" value="1" :default-checked="props.answer.is_active" />
